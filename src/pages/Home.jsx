...
import { ShoppingBag, Truck, ShieldCheck, Clock, ChevronRight, Leaf, Star, Heart } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="space-y-40 pb-40">
      ...
      <section className="overflow-hidden bg-white/40 py-10 border-y border-white">
        <div className="container overflow-x-auto hide-scrollbar">
          <div className="flex gap-16 md:gap-24 min-w-max px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            { 
              ...
              title: "Purity Check", 
              desc: "Every product undergoes multi-stage quality control." 
            },
            { 
              icon: <Truck size={40} className="text-primary" />, 
              title: "Smart Logistics", 
              desc: "Real-time tracking and temperature-controlled storage." 
            },
            { 
              icon: <Clock size={40} className="text-primary" />, 
              title: "Priority Care", 
              desc: "Dedicated support for our premium hub members." 
            }
          ].map((item, i) => (
            <div key={i} className="glass-card p-10 space-y-6 hover:translate-y-[-10px] transition-all duration-500 border-white/60">
               ...
               <p className="text-primary/60 font-medium leading-relaxed">{item.desc}</p>
