...
//             <div className="w-12 h-[1px] bg-black" />
//           </div>
//           <p className="text-[10px] text-primary/20 font-black uppercase tracking-[0.4em]">Returning to Home in 8 Seconds</p>
...
const Checkout = () => {
  ...
  const addresses = [
    { id: 1, type: 'Home', address: '71 SmoothField Court, London' },
    { id: 2, type: 'Work', address: '12 High Street, London' },
  ];
    ...
    <div className="container pt-16 md:pt-20 pb-40">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="glass-card p-6 md:p-8 space-y-6">
            ...
            <div className="grid gap-4">
              ...
              {/* Add new address */}
              <div className="p-4 border border-dashed rounded-xl text-center text-primary/60 hover:border-primary cursor-pointer">
                + Add New Address
              </div>
            </div>
          ...
          {step === 2 && (
            <div className="glass-card p-6 md:p-8 space-y-6">
              ...
              >
                Pay £{cartTotal.toFixed(2)} – Proceed to Payment
        ...
        <div className="lg:col-span-4">
          <div className="bg-white rounded-2xl p-6 space-y-6 border border-gray-100 sticky top-24">
            ...
            <div className="text-xs text-primary/50 space-y-2 pt-2">
