        ...
        <aside className="w-full lg:w-80 space-y-10">
          ...
          <div className="bg-white/40 ring-1 ring-white/60 rounded-[40px] p-4 flex flex-col gap-2">
            {[
              ...
              { icon: <MapPin size={20} />, label: "Manage Address" },
            ].map((item, i) => (
              <button
                key={i}
                className={`w-full flex items-center justify-between px-6 py-5 rounded-[24px] transition-all duration-500 group ${item.active
              ...
              >
                ...
                <ChevronRight size={16} className={`transition-all ${item.active
        ...
        <div className="flex-1 space-y-20">
          ...
          <section className="glass-card p-12 border-white/60 space-y-12 shadow-[0_40px_100px_rgba(27,60,26,0.05)]">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              ...
              <button className="text-[10px] font-black text-primary underline decoration-2 underline-offset-8 uppercase tracking-widest">
                Update Information
              </button>
            </div>
              ...
              {orders.map((order, i) => (
                ...
                >
                  ...
                  <div className="text-right flex flex-col items-end gap-2">
                    ...
                    <button className="text-[9px] font-black text-gray-300 hover:text-primary uppercase tracking-widest border border-gray-100 px-3 py-1.5 rounded-full transition-all">
                      Track Order
                    </button>
                  </div>
                </motion.div>
